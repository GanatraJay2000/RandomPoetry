        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="allPoems.php">All Poems</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container my-5">
        <div class="row">
            <div class="list-group col-md-3 mx-2 px-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button class="<?php echo $class; ?>" id="<?php echo "v-pills-" . $key . "-tab"; ?>"
                    data-bs-toggle="pill" data-bs-target="<?php echo "#v-pills-" . $key; ?>" type="button" role="tab"
                    aria-controls="<?php echo "v-pills-" . $key; ?>" aria-selected="true">
                    <?php echo $poem['title']; ?>
                </button>
                <?php } ?>
            </div>
            <div class="mx-2 col-md-7">
                ...
                <div class="tab-content card px-2 py-4 shadow-sm " id="v-pills-tabContent">
                    ...
                    <div class="<?php echo $class ?>" id="<?php echo "v-pills-" . $index; ?>" role="tabpanel"
                        aria-labelledby="<?php echo "v-pills-" . $index . "-tab"; ?>">
